	...
	<div class="wrapper" style="height: auto; min-height: 100%;">
		...
		<div class="content-wrapper" style="min-height: 621px;">
			...
			<div class="box box-info">
				...
				<form action="ThemThietBiServlet" method="post">
					<div class="box-body">
						<div class="row">
							<!-- /.col-lg-6 -->
							<div class="col-lg-6">
								<div class="form-group">
									<label for="inputPassword3" class="col-sm-3 control-label">Mã
										Thiết Bị </label>
									<div class="col-sm-6">
										<input type="text" class="form-control"
											name="maThietBi" id="input" placeholder="">
									</div>
								</div>
							</div>
							<!-- /.col-lg-6 -->
							<div class="col-lg-6">
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control"
											name="tenThietBi" id="input" placeholder="">
									</div>
								</div>
							</div>
							...
							<div class="col-lg-6">
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control"
											name="soLuong" id="input" placeholder="">
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-lg-6">
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control"
											name="donGia" id="input" placeholder="">
									</div>
								</div>
							</div>
						</div>
			...
			<div class="box-footer" align="center">
				<button type="submit" name="them" value="them" class="btn btn-default">Thêm</button>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
